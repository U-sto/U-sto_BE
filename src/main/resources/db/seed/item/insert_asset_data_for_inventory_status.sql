...
VALUES
    ...
    -- [그룹 2: 2개 물품 - 불용 상태 → DEL_YN='Y' 처리 예정 (보유현황 제외)]
 ...
 * 2행: 취득일 2024-01-15 | 부서: 없음 | 상태: 반납 | 금액: 2000000 | 연수: 5년 | 비고: 반납 완료 | 수량: 3대
 * 3행: 취득일 2024-01-15 | 부서: 없음 | 상태: 불용 | 금액: 2000000 | 연수: 5년 | 비고: 고장으로 불용 | 수량: 2대
 *
 *
 * [1행 클릭 시 상세 조회]
