...
CREATE TABLE `TB_ITEM001M` (
  ...
  CONSTRAINT `FK_ITEM001M_USR` FOREIGN KEY (`ACQ_USR_ID`) REFERENCES `TB_USER001M` (`USR_ID`),
  CONSTRAINT `FK_ITEM001M_USR` FOREIGN KEY (`APPR_USR_ID`) REFERENCES `TB_USER001M` (`USR_ID`),
  CONSTRAINT `FK_ITEM001M_ORG` FOREIGN KEY (`ORG_CD`) REFERENCES `TB_ORG001M` (`ORG_CD`)
...
CREATE TABLE `TB_ITEM002M` (
  ...
  CONSTRAINT `FK_ITEM002M_ACQ` FOREIGN KEY (`ACQ_ID`) REFERENCES `TB_ITEM001M` (`ACQ_ID`),
  CONSTRAINT `FK_ITEM002M_ORG` FOREIGN KEY (`ORG_CD`) REFERENCES `TB_ORG001M` (`ORG_CD`)
...
CREATE TABLE `TB_ITEM002D` (
  ...
  CONSTRAINT `FK_ITEM002D_ACQ_M` FOREIGN KEY (`ACQ_ID`) REFERENCES `TB_ITEM002M` (`ACQ_ID`),
  CONSTRAINT `FK_ITEM002D_DEPT` FOREIGN KEY (`DEPT_CD`) REFERENCES `TB_ORG002M` (`DEPT_CD`)
