...
CREATE TABLE `TB_ITEM002D` (
  ...
  `G2B_M_CD`      CHAR(8)         NOT NULL COMMENT '물품분류코드',
  `G2B_D_CD`      CHAR(8)         NOT NULL COMMENT '물품식별코드',
  `DEPT_CD`       VARCHAR(50)     NULL     COMMENT '운용부서코드',
...
-- 4. TB_ITEM003M/D: 물품 반납 (M:신청서, D:상세 물품)
CREATE TABLE `TB_ITEM003M` (
                               ...
                               `APLY_AT`       DATETIME        NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '신청일자',
                               `ITEM_STS`      VARCHAR(30)     NOT NULL COMMENT '반납시 물품상태',
                               `CHG_RSN`       VARCHAR(200)    NULL     COMMENT '반납사유',
                               `APPR_USR_ID`   VARCHAR(30)     NULL     COMMENT '확정자ID',
                               `APLY_APPR_AT`  DATETIME        NULL     COMMENT '확정일자',
                               `ORG_CD`        VARCHAR(50)     NOT NULL COMMENT '조직코드',
                               PRIMARY KEY (`RTRN_M_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='물품반납 마스터';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='물품반납 상세';

-- 5. TB_ITEM004M/D: 물품 불용 (M:신청서, D:상세 물품)
CREATE TABLE `TB_ITEM004M` (
                               `DSU_M_ID`      BIGINT          NOT NULL AUTO_INCREMENT COMMENT '불용ID',
                               `APLY_USR_ID`   VARCHAR(30)     NOT NULL COMMENT '신청자ID',
                               `APLY_AT`       DATETIME        NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '신청일자',
                               `ITEM_STS`      VARCHAR(30)     NOT NULL COMMENT '상태',
                               `CHG_RSN`       VARCHAR(200)    NULL     COMMENT '사유',
                               `APPR_USR_ID`   VARCHAR(30)     NULL     COMMENT '확정자ID',
                               `DSU_APPR_AT`   DATETIME        NULL     COMMENT '확정일자',
                               `ORG_CD`        VARCHAR(50)     NOT NULL COMMENT '조직코드',
                               PRIMARY KEY (`DSU_M_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='물품불용 마스터';
...
CREATE TABLE `TB_ITEM004D` (
                               ...
                               `DEPT_CD`       VARCHAR(50)     NOT NULL COMMENT '운용부서코드',
                               `APPR_STS`      VARCHAR(30)     NOT NULL DEFAULT 'WAIT' COMMENT '승인상태',
                               `DISP_TYPE`     VARCHAR(30)     NULL     DEFAULT 'DISCARD' COMMENT '처분방식',
                               `ORG_CD`        VARCHAR(50)     NOT NULL COMMENT '조직코드',
                               PRIMARY KEY (`DSU_D_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='물품불용 상세';

-- 6. TB_ITEM005M & 006M: 상태 변경 이력 및 최종 처분 이력
CREATE TABLE `TB_ITEM005M` (
                               ...
                               `APPR_USR_ID`   VARCHAR(30)     NULL,
                               `APPR_AT`       DATETIME        NULL,
                               `ORG_CD`        VARCHAR(50)     NOT NULL,
                               PRIMARY KEY (`ITEM_HIS_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='물품상태변경 이력';
...
CREATE TABLE `TB_ITEM006M` (
                               ...
                               `ORG_CD`        VARCHAR(50)     NOT NULL,
                               PRIMARY KEY (`ITEM_HIS_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='물품최종처분 이력';