package com.usto.api.item.disuse.domain.service;
...
public class DisusePolicy {
     ...
     * 조직 소유권 검증
     */
    public void validateOwnership(DisuseMaster master, String requestOrgCd) {
     ...
     * 승인 취소 가능 여부 검증
     */
    public void validateCancellable(DisuseMaster master) {
